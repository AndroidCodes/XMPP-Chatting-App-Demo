package com.example.xmpp_chatting_app_demo.dataBase;
...
public class AppDataBase {
    ...
    public static final String DATABASE_NAME = "isrk_chat.db";
    ...
    private static final String CREATE_DATABASE = "create table " + DATABASE_TABLE_NAME +
            ...
            KEY_GROUP_NAME + " text, " + KEY_MSG_ID + " text, " + KEY_SENDER + " text , " +
            KEY_MESSAGE + " text," + KEY_DATE_TIME + " text," +
            KEY_IS_MSG_READ + " text);";
    ...
    public synchronized ArrayList<ChatMessage> getAllMessages(String group_name) {
        ...
        try {
            ...
            String selectMsgesQuery = "select * from " + DATABASE_TABLE_NAME + " where " +
                    KEY_GROUP_NAME + " = '" + group_name + "' order by " + KEY_DATE_TIME;
                    ...
                    chatMessagesList.
                            add(new ChatMessage(chatMsgsListCursor.getString(chatMsgsListCursor.
                                    ...
                                    chatMsgsListCursor.getString(chatMsgsListCursor.
                                            getColumnIndexOrThrow(KEY_GROUP_NAME)),
                                    chatMsgsListCursor.getString(chatMsgsListCursor.
    ...
    public synchronized void insertMessagesToDB(String user_id, String group_name, String msg_id,
        ...
        try {
            ...
            String insertQuery = "insert or replace into " + DATABASE_TABLE_NAME + " (" +
                    KEY_USER_ID + ", " + KEY_GROUP_NAME + ", " + KEY_MSG_ID + ", " + KEY_SENDER +
            ...
            stmt.bindString(6, date_time);
            stmt.bindString(7, is_msg_read);
    ...
    public ArrayList<String> getNewUnreadMessagesForNotification() {
        ...
        String unreadMessagesNotificationQuery = "select " + KEY_SENDER + "," + KEY_MESSAGE +
                ...
                KEY_SENDER + "!='" + Common.CHAT_USERNAME + "'";
