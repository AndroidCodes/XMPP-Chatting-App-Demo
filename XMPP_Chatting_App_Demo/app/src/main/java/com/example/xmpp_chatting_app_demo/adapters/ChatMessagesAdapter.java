package com.example.xmpp_chatting_app_demo.adapters;
...
import com.example.xmpp_chatting_app_demo.textdrawable.ColorGenerator;
...
public class ChatMessagesAdapter extends RecyclerView.Adapter<ChatMessagesAdapter.
    ...
    public ChatMessagesAdapter(Context context, ArrayList<ChatMessage> chatMessageList) {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        holder.ll_chatLayoutInside.
                setBackgroundResource(sender.equals(Common.CHAT_USERNAME) ? R.drawable.sender :
                        R.drawable.reciever);
